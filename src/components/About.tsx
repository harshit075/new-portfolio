  ...
  return (
    <section id="about" ref={containerRef} className="relative w-full py-32 overflow-hidden bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 z-10 relative">
        ...
        {/* Experience & Education Tabbed Timeline */}
        <div className="max-w-3xl mx-auto relative">
          ...
          <div className="flex gap-4 mb-12 justify-center z-10 relative">
            <button
              onClick={() => setActiveTab("experience")}
              className={`px-6 py-2.5 rounded-xl border-2 font-black uppercase text-xs tracking-wider transition-all duration-300 ${
                activeTab === "experience"
                  ? "border-[#d12b6f] dark:border-[#3fb950] bg-cyan-accent/5 text-[#d12b6f] dark:text-[#3fb950] shadow-[0_0_15px_rgba(88,166,255,0.15)]"
                  : "border-border bg-bg-secondary text-foreground hover:border-cyan-accent"
              }`}
            >
              Experience
            </button>
          ...
          <div className="absolute left-6 top-36 bottom-0 w-1 bg-border rounded-full overflow-hidden z-0" />

          {/* Timeline Nodes & Cards */}
          <div className="flex flex-col gap-12 pl-14 pt-2">
            {timelineData
                  ...
                  >
                    ...
                    <div className="p-5 md:p-6 rounded-2xl border-2 border-border bg-bg-secondary/40 backdrop-blur-sm hover:border-cyan-accent transition-colors duration-300 shadow-sm relative group">
                      ...
                      <div className="z-10 relative pl-1">
                        <h3 className="text-lg md:text-xl font-black text-foreground uppercase tracking-tight leading-none mb-1 text-left">
                          {item.title}
                        </h3>
                        <div className="text-xs font-bold text-[#d12b6f] dark:text-cyan-accent uppercase tracking-wider mb-3 text-left">
                          {item.subtitle}
                        </div>
                        <p className="text-xs md:text-sm text-foreground/80 dark:text-[#8b949e] leading-relaxed font-sans font-medium text-left">
                          {item.description}
                        </p>
                      </div>
                    </div>
